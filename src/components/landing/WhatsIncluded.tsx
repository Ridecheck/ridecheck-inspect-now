  ...
  return (
    <section className="bg-haze">
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        {/* Panel */}
        <div className="mt-5 grid gap-8 rounded-2xl border border-border bg-card p-6 shadow-soft sm:p-9 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.6fr)] lg:items-stretch lg:gap-6">
          <div className="min-w-0">
